...
public class MyLogger {
	...
	public static synchronized void startTestCase() {
		String strFileName = "AutomationLogs";
		strFileName = strFileName.replaceAll("[^a-zA-Z0-9]", "_").replaceAll("_+", "_");
		startLog(System.getProperty("user.dir"), strFileName);
		info("\n\n************** Execution Started : " + strFileName + "**************\n");
	}
